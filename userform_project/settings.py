...
SECRET_KEY = 'django-insecure-e0x9mr&86ukm2py-+n72ta3d&4$$&^)#4@q(!@0oboj6e@ioap'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['http://snehalpalve.pythonanywhere.com/']
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'snpalve20@gmail.com'
EMAIL_HOST_PASSWORD = 'bosvgsijtilgqszk'
EMAIL_USE_TLS = True
...
# EMAIL_SUBJECT_PREFIX = '[dev userform_project] '
#
# EMAIL_HOST = 'localhost'
# EMAIL_HOST_USER = FROM_EMAIL

# Enter your gmail PW from the ADMINS email entered above.
# EMAIL_HOST_PASSWORD = 'snehal@98'
# EMAIL_PORT = 587
